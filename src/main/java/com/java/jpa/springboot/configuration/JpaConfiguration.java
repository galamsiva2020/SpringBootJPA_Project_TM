package com.java.jpa.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.java.jpa.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.java.jpa.springboot.model" });
